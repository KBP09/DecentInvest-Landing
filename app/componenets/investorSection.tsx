                ...
                <div className="flex sm:flex-row flex-col items-center w-full justify-center gap-8 mt-8">
                    {investors.map((investor) => (
                        <Link key={investor.id} href={investor.link} passHref>
                            <GradientCard className="w-[250px] h-[350px] sm:w-[300px] sm:h-[400px] flex flex-col items-center justify-center gap-4 cursor-pointer transition-transform transform hover:scale-105" bgColor="rgba(37, 29, 39, 1)">
                                <div className="w-full h-full flex flex-col items-center justify-center gap-4 relative bg-[#1A1A1A] rounded-2xl p-4 shadow-lg">
                                    ...
                                    <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden border-2 border-yellow-400 relative z-10">
                                        <Image
                                            src={investor.image}
                                            alt={investor.name}
                                            objectFit="cover"
                                    ...
                                    <p className="text-gray-400 text-sm sm:text-lg font-semibold">Amount Invested: {investor.AmountInvested}</p>
                                </div>
                            </GradientCard>
                        </Link>
                    ))}
