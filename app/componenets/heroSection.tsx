  ...
  return (
    <div className="h-[65vh] sm:h-screen w-full relative flex items-center justify-center flex-col mb-8 sm:mb-0">
      ...
      <div className="min-h-screen w-full overflow-hidden flex items-center justify-center flex-col z-10">
        <div className="mt-16 absolute inset-0 z-0 hidden md:flex sm:h-screen lg:h-auto bg-cover bg-center"
          style={{
        ...
        <h2 className="text-white text-[16px] md:text-[25px] xl:text-[40px] mb-2 sm:mb-0">
          Invest Decently, Invest Decentrally
        </h2>
        <h2 className="text-white text-[12px] md:text-[15px] xl:text-[30px] sm:mb-0">
          Secure, transparent, and fair investments
        </h2>
        <button className="bg-[#FFB200] text-black font-medium w-[130px] h-[42px] sm:h-[54px] sm:w-[220px] rounded-3xl hover:bg-yellow-500 transition-colors duration-300 text-[16px] sm:text-[25px] mt-8 ">
          Get Started
        </button>
      </div>
    </div>
