...
const HeroSection = () => {
    return(
        ...
        >
          <h1 className="text-white text-[40px] sm:text-[60px] md:text-[100px] xl:text-[130px] font-bold mb-2 sm:mb-0">DecentInvest</h1>
          <h2 className="text-white text-[18px] md:text-[25px] xl:text-[40px] mb-2 sm:mb-0">Invest Decently, Invest Decentrally</h2>
          <h2 className=" text-white text-[12px] md:text-[15px] xl:text-[30px]  mb-2 sm:mb-0">Secure, transparent, and fair investments</h2>
