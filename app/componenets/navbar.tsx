        ...
        <nav className="fixed z-50 w-full top-4 md:pr-4 md:pl-4">
            <div className="max-w-screen flex flex-wrap items-center justify-between mx-auto px-4 lg:px-0 lg:mr-2 lg:pr-12 lg:ml-4 lg:w-full">
                ...
                <ul className="hidden justify-end lg:flex items-center space-x-4 text-black h-[8vh] font-bold rounded-full ml-auto bg-white px-6 lg:px-8 xl:px-11">
                    <Link href='/'><li className="hover:text-yellow-400 transition-colors duration-300 cursor-pointer">Home</li></Link>
                    <Link href='/#aboutus'><li className="hover:text-yellow-400 transition-colors duration-300 cursor-pointer">About Us</li></Link>
                    <Link href='/#newsletter'><li className="hover:text-yellow-400 transition-colors duration-300 cursor-pointer">Newsletter</li></Link>
                    <Link href='/startups'><li className="hover:text-yellow-400 transition-colors duration-300 cursor-pointer">Startups</li></Link>
                    <button className="bg-[#FFB200] text-black font-semibold py-2 px-4 rounded-lg hover:bg-yellow-500 transition-colors duration-300">
                        <Link href='/business'><li className="hover:text-yellow-400 transition-colors duration-300 cursor-pointer">Business</li></Link>
                    </button>
                </ul>
